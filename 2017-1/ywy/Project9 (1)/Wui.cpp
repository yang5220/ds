...
#define COLOR_WHITE      RGB(255,255,255)//红色
#define COLOR_BLACK      RGB(0,0,0)
#define COLOR_BOUNDARY		RGB(139, 134, 130)
#define COLOR_TEXT			RGB(173,216,230)

#define INIT_TIMER_ELAPSE	1000
#define MAX_X		8	// 游戏界面大小
#define MAX_Y		10
...
void GamePaint(HWND hwnd)
{
	...
	HBRUSH hbrushWhite;//food
	HBRUSH hBrushBlack;//snack
	HBRUSH hOldBrush;
	...
	*******************************************************************************/
	...
	if (hOldFont = (HFONT)SelectObject(hdcmem, hFont))
	{
		...
		wsprintf(szSourceInfo, "Sorce %d ", GetScore()+3);
		// 设置输出颜色
